...
namespace CommandParser.Tests {
    ...
    //FIXME: rewrite with another classes
    public class OptionTests {
        ...
        //     option[paramKey].Should().Be(paramValue);
        ...
        //     option[paramKey].Should().Be(paramValue.ToString());
        // }
        ...
        //     option.Invoking(opt => opt["Any"]).Should().Throw<KeyNotFoundException>();
